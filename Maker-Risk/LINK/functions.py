 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "Risk: \n",
    "\n",
    "Zero balance addresses: Another important point, according to data, is the growing number of the zero balance addresses in the last couple of months. These accounts transfer or sell out all of their tokens which could indicate a fair amount of speculative activity happening beyond the network fundamentals and demand for the asset.\n",
    "\n",
    "Token ownership: Token ownership concentration is one of the topics of greatest concern from a risk perspective in our view\n",
    "\n",
    "Distribution of ownership: Only 328 addresses hold 100K tokens or more. In other words, only 0.16% of addresses hold the largest shares of the network.\n",
    "\n",
    "Liquidity and price increase: reduced amount of tokens in top exchanges could be one of the reasons for the 2020 recent price increase, drawn out of shortage in liquidity.     \n",
    "\n",
    "Liquidation and price volatility from ownership concentration: This brings a significant ownership risk to the MakerDAO vault portfolio as actions by these holders, whether coordinated or not, may determine pontentially significant swings in the asset price and by extension, in case of negative swings, in increased collateral liquidations. \n",
    "\n",
    "Supply on exchanges: metric has been continuously deteriorating in the last 12 months without any significant rebounds. For risk, this reinforces the liquidity shortage likelyhood in the event of liquidations.\n",
    "\n",
    "Binance risk (single provider of liquidity): Binance has the largest market share by a considerable margin with 87.2% of tokens being stored in their wallets as of July end\n",
    "\n",
    "Trading volume risk (exchange and trading pairs): Again, this reinforces the need for a risk approach to trading volume distribution across a limited number of players and trading pairs.\n",
    "LINK/USDT and LINK/BTC on Binance and LINK/USD on Coinbase are clearly the dominating trading pairs (86.4% of total)\n",
    "\n",
    "Centralised exchange liquidity: Given the trend in the last 12 months, in the event of a significant price decline, there is a non trivial risk of lack of liquidity for MakerDAO auction keepers.\n",
    "\n",
    "Lending platforms risk + liquidity: Another aspect to take into account is the growing number of leveraging platforms such as Aave including LINK. With declining token supply on exchanges, the competition for trading activity tends to accelerate, with likely risky effects for keepers trying to liquidate LINK.\n",
    "\n",
    "Exchange trading volume: \"Real trading volume\" has fluctuated significantly across exchanges in the last two years.\n",
    "\n",
    "DEX trading volumes: In comparison to centralised exchanges, trading volume in decentralised exchanges and liquidity pools is fairly low for LINK\n",
    "But for the forseable future we expect the large majority of LINK trade still flowing through centralised exchanges.     \n",
    "\n",
    "Risk-pricing adjustments (or lack of it): From July, with the acceleration of price increases for LINK and growing debt in the platform, Aave has adjusted its risk pricing to a 5.59% max value to rein in some of the downside risks of the growing collateral reserves.\n",
    "\n",
    "Liquidation data (lack of observations):  benchmarking observation of Aave liquidations may have the advantage of informing MakerDAO's own ongoing risk policies and parameters. At least, this 3rd party liquidation data may be valuable to assist with management of future LINK vault events, while we may not have enough of our own data observations. "
   ]
  },
  {
   "cell_type": "markdown",
